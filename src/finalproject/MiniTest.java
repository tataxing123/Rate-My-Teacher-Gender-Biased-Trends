...
class MiniTest {
    ...
    public void getValueSet2() {
        ...
        received.sort(Comparator.naturalOrder());
        for (int i = 0; i < 8; i++)
            assertEquals(Character.valueOf((char) ('A' + i)), received.get(i));
    }
    ...
    public void RatingDistributionByProfessorTest() {
        Parser parser = new Parser("/src/RateMyProf_Data_Gendered_Sample.csv");
        parser.read();
        ...
        assertEquals(Integer.valueOf(0), dist.get("2"));
        assertEquals(Integer.valueOf(1), dist.get("3"));
        assertEquals(Integer.valueOf(0), dist.get("4"));
    ...
    public void RatingDistributionBySchoolTest() {
        ...
        assertEquals(Integer.valueOf(6), dist.get(key2));
    }
    ...
    public void GenderByKeyword() {
        ...
        assertEquals(Integer.valueOf(31), dist.get("F"));
        assertEquals(Integer.valueOf(1), dist.get("X"));
        assertEquals(Integer.valueOf(19), dist.get("M"));
    ...
    public void RatingByKeyword() {
        ...
        assertEquals(Integer.valueOf(12), dist.get("1"));
        assertEquals(Integer.valueOf(6), dist.get("2"));
        assertEquals(Integer.valueOf(3), dist.get("3"));
        assertEquals(Integer.valueOf(0), dist.get("4"));
        assertEquals(Integer.valueOf(0), dist.get("5"));
    }
    ...
    public void RatingByGender() {
        ...
        assertEquals(Integer.valueOf(83), dist.get("1"));
        assertEquals(Integer.valueOf(90), dist.get("2"));
        assertEquals(Integer.valueOf(126), dist.get("3"));
        assertEquals(Integer.valueOf(73), dist.get("4"));
        assertEquals(Integer.valueOf(57), dist.get("5"));
    }
}